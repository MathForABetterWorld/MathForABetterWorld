...
st.set_page_config(layout="centered", page_icon=path + "/assets/bmore_food_logo_dark_theme.png", page_title="Volunteer Metrics")
...
with title_container:
    ...
    with col2:
        st.markdown("<h1 style='text-align: center; '>Volunteer Data Plots</h1>", unsafe_allow_html=True)
